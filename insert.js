...
db.records.insert({ recid: 1, nombre: 'Jane', apellido: 'Pérez', email: 'jdoe@gmail.com', monto: 2500, fechaini: ISODate("2018-02-02T21:27:35.783Z")})

db.getCollection('records').insert([{ recid: 2, nombre: 'Stuart', apellido: 'Motzart', email: 'jdoe@gmail.com', monto: 1004, fechaini: ISODate("2018-02-27T21:27:35.783Z") },
